...
function removeLastFlavor(array){
 array.pop();
 return array;
} console.log('task 4:', addFlavor(originalFlavors, "Rainbow Sherbert"))
...
function getFlavorByIndex(array, number){
  return array[number]
} console.log('task 5:', originalFlavors[0])
...
function removeFlavorByName(array, string){
  ...
  return array;
}console.log(removeFlavorByName(originalFlavors, 'Vanilla Burnt Almond'))
